...
| **사용할 소프트웨어 패키지의 명칭과 URL** | **[ Backend ]**<br>- [Spring Boot](https://spring.io/projects/spring-boot)<br>- [MySQL](https://www.mysql.com)<br>- [AWS RDS](https://aws.amazon.com/rds/)<br>- [Docker](https://www.docker.com/)<br><br>**[ Frontend ]**<br>- [React](https://ko.react.dev/)<br><br>**[ AI ]**<br>- 자연어 처리 (NLP) : [GPT-5](https://openai.com/research/gpt-4)<br>- RAG 프레임워크 : [LangChain](https://www.langchain.com/) <br>- StateGraph 워크플로우 : LangGraph|
